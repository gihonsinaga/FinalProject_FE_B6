...
//         "https://express-development-3576.up.railway.app/api/v1/users/register",
//         user
//       );
...
//               <h1 className="flex items-center pl-3 font-semibold text-2xl bg-gradient-to-r from-[#2193FA] to-[#C1DEE2] text-transparent bg-clip-text">FlyNow</h1>
//             </div>
//             <p className="text-[24px] font-semibold pt-8">Register</p>
//             <div>
...
//                     className="bg-gray-100 h-[40px] border-[2px] md:w-[400px] w-full border-gray-100 p-2 rounded-lg text-gray-700 focus:outline-none focus:bg-white focus:border-[#2193FA]"
//                   />
//                   <button type="submit" className="shadow w-full h-[40px] self-center mt-3 bg-[#2193FA] hover:bg-[#2154fa] focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded-lg">
//                     Daftar
//                   </button>
//                 </div>
//               </form>
...
//                 <Link to="/login" className="pl-1 font-bold text-blue-500 hover:underline">Masuk disini</Link>
//               </div>
//             </div>
//             <div className="border bt-2"></div>
//             <button className="flex flex-row shadow w-full h-[40px] self-center mt-3 bg-slate-200 hover:bg-slate-300 focus:shadow-outline focus:outline-none text-black py-2 px-4 rounded-lg justify-center">
